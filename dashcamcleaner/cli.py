...
def parse_arguments():
    ...
    requiredNamed.add_argument("-i", "--input", metavar="INPUT_PATH", required=True, help="input video file path", type=str)
    requiredNamed.add_argument("-o", "--output", metavar="OUTPUT_NAME", required=True, help="output video file path", type=str)
    requiredNamed.add_argument("-w", "--weights", metavar="WEIGHTS_FILE_NAME", required=True, help="", type=str)
    requiredNamed.add_argument("--threshold", required=True, help="detection threshold", type=float)
    requiredNamed.add_argument("--blur_size", required=True, help="granularity of the blurring filter", type=int)
    requiredNamed.add_argument("--frame_memory", required=True, help="blur objects in the last x frames too", type=int)
